...
namespace Neutronium.Content.Items.Armor
{
    ...
    public class SchwarzchildHelmet : ModItem
    {
        ...
        {
            return body.type == ModContent.ItemType<SchwarzchildChestplate>() && legs.type == ModContent.ItemType<SchwarzchildGreaves>();
        }

        // UpdateArmorSet allows you to give set bonuses to the armor.
        public override void UpdateArmorSet(Player player)
        {
            player.setBonus = "Increases Stellar damage by 10%";
            player.GetModPlayer<GlobalPlayer>().StellarDamage += 0.1f;
        }
