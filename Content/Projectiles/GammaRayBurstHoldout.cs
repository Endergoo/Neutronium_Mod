...
{
    public class GammaRayBurstHoldout : ModProjectile
    {
        ...
        private void FireBeams()
        {
            ...
            {
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, beamVelocity, ModContent.ProjectileType<GammaRayBurstBeam>(), damage, knockback, Projectile.owner, b, uuid);
            }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color drawColor = GammaRayBurst.OverrideColor;
