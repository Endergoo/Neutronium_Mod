...
{
    public class BlazarBurst : ModProjectile, ILocalizedModType
    {
        ...
        public override void AI()
        {
            ...
            while ((float)timerCounter < projTimer)
            {
                ...
                int orngDust = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.Torch, 0f, 0f, 100, default, 2f);
